...
<body class="min-h-svh tantangan">
    <div class="flex justify-center w-full px-24 py-6">
        <header
            class="rounded-[20px] h-[600px] flex relative flex-col overflow-hidden items-center w-full bg-white shadow-lg">
    ...
    <div class="w-full h-full px-32 py-6 mt-4">
        <div
