            ...
            <div class="flex flex-col justify-center w-full h-full py-12 shadow-2xl form-login px-14">
                ...
                <div class="flex flex-col items-center justify-center h-full gap-4">
                    <div class="flex flex-col items-center justify-center w-full gap-4">
                        ...
                        <div class="flex flex-col items-center justify-center w-full gap-5">
                            ...
                            <div class="w-full text-center">
                                ...
                                <p class="mt-2 text-xs text-hitam-400">Don't have an account? <a href="{{route ('signup')}}"
                                        class="text-xs text-biru-6 hover:text-biru-6">Sign Up</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="grid gap-2 place-content-center place-items-center">
                        ...
                        <button
                            class="flex items-center gap-1 px-3 py-2 text-lg font-extrabold transition-all font-jkt bg-biru-1 hover:bg-biru-6 text-hitam-800 focus:outline-none rounded-xl"><i
