  ...
  <div class="px-2 drawer-body">
    <ul class="p-0 menu">
      ...
      <li class="space-y-0.5">
        <a class="collapse-toggle collapse-open:bg-base-content/10" id="menu-konselor" data-collapse="#menu-konselor-collapse">
        ...
        <ul id="menu-konselor-collapse" class="collapse hidden w-auto overflow-hidden transition-[height] duration-300"
          ...
          <li class="nested-collapse-wrapper">
            <a class="collapse-toggle nested-collapse" id="sub-menu-academy" data-collapse="#sub-menu-academy-collapse">
      ...
      <!-- All About Konselor Dropdown -->
       ...
       <li class="space-y-0.5">
        <a class="collapse-toggle collapse-open:bg-base-content/10" id="menu-artikel" data-collapse="#menu-artikel-collapse">
          <span class="icon-[flowbite--book-outline] size-5"></span>
          Artikel
          <span class="icon-[tabler--chevron-down] collapse-open:rotate-180 size-4 transition-all duration-300"></span>
        </a>
        <ul id="menu-artikel-collapse" class="collapse hidden w-auto overflow-hidden transition-[height] duration-300"
